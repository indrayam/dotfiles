...
# Custom Aliases (AS) gdt alias was duplicated; changing it to gdtr
...
# Custom Aliases (AS) - Using difftool to pull up diff between staged stuff and repo
alias gdtc='git difftool --cached'
# Custom Aliases (AS) - Removing '-v' from al gc related aliases
alias gc='git commit'
...
compdef ggpull=git
# Custom Aliases (AS) - Naming it similar to ggpull
alias ggpulr='git pull --rebase origin $(current_branch)'
compdef ggpulr=git
alias ggpush='git push origin $(current_branch)'
compdef ggpush=git
# Custom Aliases (AS) - Naming ggpnp to ggsync
